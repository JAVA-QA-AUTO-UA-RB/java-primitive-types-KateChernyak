...
public class Main {
    public static void main(String[] args) {
        ...
        int favoriteNumber = userInput.nextInt(); // Replace _ with the correct type and variable
        ...
        double decimalNumber = userInput.nextDouble(); // Replace _ with the correct type and variable
        ...
        char character = userInput.next().charAt(0); // Replace _ with the correct type and variable
        ...
        boolean likesPizza = userInput.nextBoolean(); // Replace _ with the correct type and variable
        ...
        // Close the scanner
        userInput.close(); // Replace _ with the correct scanner variable
    }
}